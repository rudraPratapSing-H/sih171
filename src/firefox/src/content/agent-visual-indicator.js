/**
 * KavachWeb Agent Visual Indicator (content script)
 *
 * Renders an animated purple inset glow around the page viewport while
 * the agent is operating on this tab, a "Stop KavachWeb" floating button,
 * and a large KavachWeb-purple cursor/outline on the element currently
 * being acted on. The base indicator follows Anthropic's Claude-for-Chrome
 * extension pattern, recolored for KavachWeb's accent (#6c63ff).
 *
...
(function () {
  ...
  function createStopButton() {
    ...
    button.innerHTML = `
      ...
      <span style="vertical-align: middle;">Stop KavachWeb</span>
    `;
