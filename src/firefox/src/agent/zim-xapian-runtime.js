 ...
 * index check therefore comes from KavachWeb's own ZIM reader, passed in here,
 ...
 * @param options.hasFullTextIndex  (record) => Promise<boolean>, answered by KavachWeb's reader.
 */
