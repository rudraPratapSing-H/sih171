...
(`@lobehub/icons-static-svg`, MIT). Filenames match KavachWeb provider ids.
...
| local_openai_proxy, webgpu | KavachWeb-authored generic local-runtime marks |
...
| webbrain_cloud | KavachWeb extension icon |
