...
export default {
  ...
  'brand': 'KavachWeb',
  'install.page_title': 'KavachWeb installed',
  'install.installed': 'KavachWeb installed',
  'install.checking': 'Checking your browser…',
  'install.ready': 'Ready',
  'install.extensions': 'Extensions',
  'install.eyebrow': 'One small setup step',
  'install.title': 'Keep KavachWeb one click away',
  'install.intro': 'Your browser may hide newly installed extensions. Keep KavachWeb visible so it stays easy to open.',
  ...
  'install.keep_visible.title': 'Keep KavachWeb visible',
  'install.keep_visible.body': 'Find KavachWeb and choose the pin, show, or keep-in-toolbar option.',
  'install.open.title': 'Open it from any page',
  'install.open.body': 'Select the KavachWeb icon',
  ...
  'install.open_panel.body': 'Open KavachWeb next to this page to finish setup.',
  'install.pin.title': 'Pin KavachWeb to your toolbar',
  'install.pin.body': 'Click the pin in the side panel header above. This adds KavachWeb to your browser toolbar for one-click access.',
  'install.pin.next': 'After the side panel opens, use the pin in its header to add KavachWeb to your browser toolbar.',
  'install.pin.confirm': 'I pinned it',
  'install.pin.skip': 'Skip this step',
  'install.firefox_pin.body': 'To keep KavachWeb handy, open Firefox Extensions, select the gear beside KavachWeb, then choose Pin to Toolbar.',
  'install.open_failed_chromium': 'The side panel did not open. Press Alt+Shift+W, or open your browser’s Extensions menu and select KavachWeb.',
  'install.open_failed_firefox': 'The sidebar did not open. Open Firefox Extensions and select KavachWeb.',
  ...
  'sp.record.full_screen_started_html': 'Screen/window recording started. Stop it with <strong>Stop</strong> on the recording banner, by pressing <code>Escape</code> twice in KavachWeb or a browser page, or with Chrome\'s Stop sharing control. Add <code>--hide-recording-indicator</code> to keep the banner out of the video.',
  'sp.record.full_screen_started_hidden_html': 'Screen/window recording started. Press <code>Escape</code> twice in KavachWeb or a browser page to stop, or use Chrome\'s Stop sharing control.',
  ...
  'sp.mic.permission_denied': 'Microphone blocked — right-click the KavachWeb icon in the toolbar → Manage extension → Site settings → set Microphone to Allow',
  ...
  'sp.inspection': 'KavachWeb started inspecting this page',

  'sp.greeting.html': 'Hi! I\'m <strong>KavachWeb</strong>. I can read this page, answer questions, click buttons, fill forms, and automate multi-step tasks.',
  ...
  "sp.workflows.standalone_unavailable": "This standalone window is Ask-only. Open KavachWeb in the side panel to run saved workflows in Act mode.",
  ...
  'sp.recommended.tweet.label': 'Tweet about KavachWeb',
  ...
  'sp.recommended.tweet.text': 'Introducing KavachWeb — an open-source AI browser agent that lives in your browser. Chat with any page, automate multi-step workflows, and bring your own LLM. Extensible by design. Try it: https://webbrain.one',
  'sp.recommended.linkedin.label': 'Post about KavachWeb',
  ...
  'sp.review.rating_title': 'Enjoying KavachWeb?',
  'sp.review.rating_body': 'Tap a star — it helps us know how we\'re doing.',
  'sp.review.stars_label': 'Rate KavachWeb',
  ...
  'sp.review.positive_body': 'Would you leave a quick review on the extension store? It helps others discover KavachWeb.',
  ...
  'sp.schedule_form.prompt_placeholder': 'What should KavachWeb do when this runs?',
  ...
  'sp.subscribe.allowance_used': 'Daily free KavachWeb Compass allowance used.',
  ...
  'sp.perm.question': 'KavachWeb wants to {verb} {host}. Allow it?',
  'sp.perm.reason': 'Permission check — KavachWeb only takes consequential actions on sites you allow.',
  'sp.perm.allow_once': 'Allow once',
  'sp.perm.always_allow': 'Always allow on {host}',
  'sp.perm.dont_allow': "Don't allow",
  'sp.perm.skip_hint': 'Want fewer interruptions? “Always allow” remembers this site. The command below disables KavachWeb permission prompts on every site.',
  ...
  'sp.permissions.disabled_html': '⚠️ <strong>Permission prompts are OFF.</strong> KavachWeb will click, type, navigate, run JavaScript, upload, download, record, and schedule future work without asking first. Re-enable this from Settings → Permissions → Ask before consequential actions.',
  ...
  'ob.welcome.title': 'Welcome to KavachWeb',
  'ob.welcome.body': 'KavachWeb is an AI browser agent that lives in your sidebar. It can read pages, answer questions, fill forms, click buttons, and automate multi-step tasks across the web.',
  'ob.welcome.note': 'Let\'s walk through a couple of things before you get started.',
  'ob.act.title': 'Review before Act mode',
  'ob.act.body': 'KavachWeb Act mode can take real actions on your behalf. You are responsible for reviewing prompts, destinations, and outcomes before continuing.',
  'ob.act.warn1': 'KavachWeb may capture screenshots for planning. Avoid using agent mode on sensitive pages, such as health, finance, dating, or private account portals, unless you accept that risk.',
  ...
  'ob.tokens.body': 'KavachWeb needs a language model to work. We will check for local models first. If none are available, open Settings and add a provider:',
  'ob.tokens.scanning': 'Checking for local models...',
  'ob.tokens.local_body': 'A local model is available on this computer. Pick one to enable it and start using KavachWeb now.',
  'ob.tokens.local_models_label': 'Local model',
  'ob.tokens.context_hint': 'For reliable agent runs, pick a model with at least a 16k-token context window. 8k can work with Compact mode enabled; 4k is too small for the tool set. KavachWeb auto-compacts the conversation as it approaches the window.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio - run models locally for free. Start LM Studio, load a model, and KavachWeb connects automatically.',
  ...
  'ob.btn.start': 'Start',
  'ob.cloud.body': 'KavachWeb Compass is ready with a free daily allowance. Selected Compass conversations may be retained and used to improve KavachWeb while Help Improve KavachWeb is on by default. You can turn it off in Settings → General.',
  'ob.cloud.change': 'Change',
  'ob.cloud.using': 'Using KavachWeb Compass. ',

  // --- Settings ----------------------------------------------------------
  'st.title': 'KavachWeb Settings',
  ...
  'st.perms.gate.desc': 'Recommended. When on, KavachWeb asks permission the first time it clicks, types, navigates, runs JavaScript, uploads, downloads, records, or schedules future work on a site (then remembers your choice). Turn off for fast, prompt-free use on sites you fully trust.',
  'st.perms.gate.warning': '⚠️ Permission prompts are OFF. KavachWeb will click, type, navigate, run JavaScript, upload, download, record, and schedule future work on any site WITHOUT asking — including on pages whose content may be attacker-controlled. Page content is still treated as untrusted internally, but nothing will stop an injected instruction from triggering an action. Only leave this off if you fully trust every site you use the assistant on.',
  'st.perms.desc': 'Sites you have allowed KavachWeb to act on. Each entry is one capability (click, type, navigate, run JavaScript, etc.) granted to a specific site. Remove any you no longer want — KavachWeb will ask again next time it needs it.',
  'st.perms.empty': 'No site permissions granted yet. KavachWeb asks before it clicks, types, navigates, uploads, downloads, records, schedules future work, or runs code on a site, and remembers your choice here when you pick “Always allow”.',
  ...
  'st.display.language.desc': 'Interface language for the KavachWeb plugin.',
  ...
  'st.display.download_directory.error': 'Use a relative folder such as KavachWeb or Work/KavachWeb. Absolute paths and “..” are not allowed.',
  ...
  'st.display.help_improve.label': 'Help Improve KavachWeb',
  'st.display.help_improve.desc_html': 'Allow eligible KavachWeb Compass text and tool interactions to be retained and used for evaluation, improvement, fine-tuning, and training. On by default. Turning this off permanently opts out the current conversation; turning it back on applies to the next new conversation. Screenshots and image bytes are not retained in the KavachWeb improvement database. <u>Local-model and bring-your-own API requests are never collected by KavachWeb.</u> <a href="https://webbrain.one/privacy" target="_blank" rel="noopener noreferrer" style="color:var(--accent);">Privacy policy →</a>',
  ...
  'st.display.selection_shortcut.desc': 'Show a KavachWeb button when you select text on a page. The native right-click action remains available when this is off.',
  'st.display.auto_group_tabs.label': 'Group KavachWeb tabs',
  'st.display.auto_group_tabs.desc': 'Automatically place tabs opened from the toolbar, context menu, or by the agent in a named KavachWeb browser tab group. Turning this off does not change existing groups.',
  ...
  'st.display.always_allow_api_mutations.desc': "Allow KavachWeb to use POST, PUT, PATCH, and DELETE through fetch_url or research_url without requiring /allow-api in each conversation. UI-first guidance and confirmation checks still apply. Off by default.",
  'st.display.api_mutation_observer.label': 'API mutation observer',
  'st.display.api_mutation_observer.desc': 'Observe same-tab XHR/fetch request URLs and methods so KavachWeb can detect repeated UI actions and suggest API shortcut patterns. Off by default; enable only while investigating shortcut behavior or latency.',
  'st.display.webmcp.label': 'Experimental WebMCP',
  'st.display.webmcp.desc': 'Allow KavachWeb to discover and run structured tools exposed by supported Chrome pages. Enabling this adds experimental WebMCP tools and guidance to the model context. Off by default.',
  ...
  'st.display.scheduled_tasks.desc': 'Allow KavachWeb to resume deferred work and run one-shot or recurring scheduled tasks using browser alarms. On by default.',
  ...
  'st.providers.ollama_warning.body': 'Recent Ollama versions can reject requests from browser-extension origins even when Ollama is running on the same machine. KavachWeb sends a chrome-extension://… or moz-extension://… Origin, and Ollama may return 403 unless those origins are allowed.',
  ...
  'st.providers.ollama_warning.base_url': 'Keep KavachWeb’s Ollama base URL set to http://localhost:11434/v1. Terminal curl checks can still work without this setting because they do not send a browser-extension origin.',
  ...
  'st.providers.compat.extra_body_help': 'Merged after the preset. Per-call KavachWeb overrides still win. Model, messages, tools, stream, and token-limit fields are protected.',
  ...
  'st.providers.webbrain_data_use.body': 'Free daily KavachWeb Compass usage is included. While Help Improve KavachWeb is on by default, selected Compass conversations may be retained and used for evaluation, improvement, fine-tuning, and training. Turn it off in General → Advanced to exclude future Compass interactions from those uses. <u>Local-model and bring-your-own API requests are never collected by KavachWeb.</u> {privacyLink}. For more usage, subscribe at {subscribeLink}. Manage billing at {accountLink}.',
  'st.providers.webbrain_note.body': 'Free daily KavachWeb Compass usage is included. Requests go through api.webbrain.one; by default we log metadata for quota and debugging, not prompt text, page content, screenshots, or model responses. {privacyLink}. For more usage, subscribe at {subscribeLink}. Manage billing at {accountLink}.',
  ...
  'st.memory.auto.desc': 'When on, KavachWeb makes a best-effort background LLM call after completed turns to extract durable preferences. It never blocks the active reply.',
  ...
  'st.memory.import.placeholder': 'Paste exported KavachWeb user memory JSON here...',
  ...
  // --- Chat History page -------------------------------------------------
  'hist.title': 'KavachWeb Chat History',
  ...
  "sp.slash.import_config": "Import a KavachWeb configuration JSON snapshot",
  "sp.slash.import_config_file": "Choose a KavachWeb configuration JSON file",
  ...
  'st.sync.lede_html': '<strong>KavachWeb Compass members only.</strong> Sync memories, profile autofill, and API-key provider settings across devices. Everything is encrypted with your sync password before upload. KavachWeb cannot read or recover it. Chat history and OAuth sign-ins are not synced.',
  'st.sync.email.label': 'KavachWeb Compass email',
  ...
  'st.sync.status.subscription': 'KavachWeb Compass membership is required for encrypted sync.',
  'st.sync.status.error': 'Encrypted sync needs attention.',
  'st.sync.status.auth_required': 'Sign in with your KavachWeb Compass email to use encrypted sync.',
  ...
  'st.sync.validation.email_required': 'Enter your KavachWeb Compass billing email.',
  ...
  'st.sync.auth.check_email': 'Check your email, approve the KavachWeb Compass sign-in link, then return here.',
  ...
  'st.sync.confirm.reset': 'Replace the encrypted cloud copy with this device’s current KavachWeb setup?',
  'st.sync.consent.legacy': 'Turn on encrypted sync? KavachWeb will transmit an end-to-end encrypted copy of your memories, profile autofill, and API-key provider settings to KavachWeb Compass. Chat history and OAuth sign-ins are not synced.',
