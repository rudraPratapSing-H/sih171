    ...
    updates: [
      {
        ...
        data: {
          ...
          args: {
            ...
            prompt: 'Use KavachWeb CI A with a random shirt size and random harmless comment. Use set_field and verify_form, submit exactly once, and finish only after the response was recorded.',
          },
        },
      },
      { type: 'tool_result', data: { name: 'schedule_task', result: { success: true, jobId: 'task_1' } } },
      {
        ...
        data: {
          ...
          args: {
            ...
            target: { type: 'url', url: 'https://forms.gle/nDSbn2B6Cym4x9Bi8' },
            prompt: 'Use KavachWeb CI B with a random shirt size and random harmless comment. Use set_field and verify_form, submit exactly once, and finish only after the response was recorded.',
          },
        },
      },
