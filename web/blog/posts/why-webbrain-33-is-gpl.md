---
title: >
  Why KavachWeb 33.0.0 is GPL
slug: why-webbrain-33-is-gpl
sortOrder: -210
date: 2026-08-20
readTime: 2 min read
description: >
  KavachWeb 33.0.0 ships under GPL-3.0-or-later because the extension bundles the Xapian/libzim WebAssembly runtime for full-text Wikipedia ZIM search. Releases before 33.0.0 remain MIT.
excerpt: >
...
titleTag: >
  Why KavachWeb 33.0.0 is GPL - KavachWeb Blog
ogTitle: >
  Why KavachWeb 33.0.0 is GPL
ogDescription: >
...
lede: >
  **KavachWeb 33.0.0 is GPL-3.0-or-later.** Tagged releases before that stay MIT.
---
